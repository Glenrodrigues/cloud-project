...
const dbUrl=`mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@foodapp.mjg4p.mongodb.net/${process.env.MONGO_DATABASE}?retryWrites=true&w=majority`
